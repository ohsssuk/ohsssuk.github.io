class ProjectList {
  data = [
    ...
    },
    {
      ...
      service:
        "디자이너 웹 포트폴리오 입니다.<br>디자이너가 사이트 관리가 가능하도록 Admin을 제공합니다.<br>로그를 기록하여 채용 담당자가 어떤 작품을 유심히 봤는지 디자이너가 체크할 수 있도록 만들었습니다.",
      stack: [
        { tag: "bac", text: "PHP" },
        { tag: "db", text: "mySql" },
        { tag: "fro", text: "javascript" },
      ...
      link: "http://www.johyuk.com",
      thumb: {
        image: "./images/work/work_5/1.PNG",
